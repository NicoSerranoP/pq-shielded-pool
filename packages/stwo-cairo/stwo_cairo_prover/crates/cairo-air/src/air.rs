...
impl CairoSerialize for PublicSegmentRanges {
    fn serialize(&self, serialized: &mut Vec<starknet_ff::FieldElement>) {
        ...
        CairoSerialize::serialize(output, serialized);
        CairoSerialize::serialize(pedersen, serialized);
        CairoSerialize::serialize(range_check_128, serialized);
        CairoSerialize::serialize(ecdsa, serialized);
        CairoSerialize::serialize(bitwise, serialized);
        CairoSerialize::serialize(ec_op, serialized);
        CairoSerialize::serialize(keccak, serialized);
        CairoSerialize::serialize(poseidon, serialized);
        CairoSerialize::serialize(range_check_96, serialized);
        CairoSerialize::serialize(add_mod, serialized);
        CairoSerialize::serialize(mul_mod, serialized);
    }
}
...
impl CairoDeserialize for PublicSegmentRanges {
    fn deserialize<'a>(data: &mut impl Iterator<Item = &'a starknet_ff::FieldElement>) -> Self {
        let output = CairoDeserialize::deserialize(data);
        let pedersen = CairoDeserialize::deserialize(data);
        let range_check_128 = CairoDeserialize::deserialize(data);
        let ecdsa = CairoDeserialize::deserialize(data);
        let bitwise = CairoDeserialize::deserialize(data);
        let ec_op = CairoDeserialize::deserialize(data);
        let keccak = CairoDeserialize::deserialize(data);
        let poseidon = CairoDeserialize::deserialize(data);
        let range_check_96 = CairoDeserialize::deserialize(data);
        let add_mod = CairoDeserialize::deserialize(data);
        let mul_mod = CairoDeserialize::deserialize(data);
