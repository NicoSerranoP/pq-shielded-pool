...
pub fn mock_public_memory_with_outputs(output_len: u32) -> PublicMemory {
    ...
    PublicMemory {
        ...
        public_segments: PublicSegmentRanges {
            ...
            pedersen: Option::Some(empty_segment),
            range_check_128: Option::Some(empty_segment),
            ecdsa: Option::Some(empty_segment),
            bitwise: Option::Some(empty_segment),
            ec_op: Option::Some(empty_segment),
            keccak: Option::Some(empty_segment),
            poseidon: Option::Some(empty_segment),
            range_check_96: Option::Some(empty_segment),
            add_mod: Option::Some(empty_segment),
            mul_mod: Option::Some(empty_segment),
        },
        output: output.span(),
        safe_call_ids: [1, 2],
    }
