...
fn test_hash_node_with_no_children() {
    assert_eq!(
        Blake2sMerkleHasher::hash_node(None, array![m31(0), m31(1)].span()).hash,
        [
...
fn test_hash_node_with_children() {
    ...
    assert_eq!(
        Blake2sMerkleHasher::hash_node(Some((l_node, r_node)), array![m31(3)].span()).hash,
        [
...
fn test_hash_node_with_many_values() {
    ...
    assert_eq!(
        Blake2sMerkleHasher::hash_node(Some((l_node, r_node)), values.span()).hash,
        [
