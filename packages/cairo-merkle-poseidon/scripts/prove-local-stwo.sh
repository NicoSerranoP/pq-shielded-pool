...
PROOF_PATH="${PROOF_PATH:-$POSEIDON_DIR/target/local-proofs/merkle-poseidon-proof.json}"
PARAMS_PATH="${STWO_PARAMS_JSON:-$POSEIDON_DIR/inputs/stwo_local_params.json}"
...
echo "Local Poseidon Merkle proof generated and verified: $PROOF_PATH"
